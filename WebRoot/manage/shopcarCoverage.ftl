...
<div id="shopcarCoverMap" class="claro" style="float: left; width: 100%;height: 100%;"/>
...
<script type="text/javascript">
  jQuery(function() {
	dojo.addOnLoad(shopcarCoverMapInit);
});

</script>

<input type="hidden" id="orderLists" value = "${orderList}" />
