			...
			<div class="container-fluid">
				...
				<!-- BEGIN PAGE CONTENT-->
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                <#if getCustomSingleOrder?? && (getCustomSingleOrder?size > 0)>
				             
				                <#list getCustomSingleOrder as order>
...
<!--查询详情表窗口 start -->
 <div class="row-fluid"  id='showpssorderinfo'  >
					<div class="tab-content">
						<form action="#" class="form-horizontal">
						<input type="hidden" value="" id='order_id'  name='id' >
		...
		<table cellspacing="4" cellpadding="0" border="0">
			<tbody>
				<tr>
					...
					<td><@spring.message "LatitudeLeft=左上纬度"/> :</td>
