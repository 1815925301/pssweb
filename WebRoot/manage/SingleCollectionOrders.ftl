			...
			<div class="container-fluid">
				...
				<!-- BEGIN PAGE CONTENT-->
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                <#if getSingleCollectionOrders?? && (getSingleCollectionOrders?size > 0)>
				             
				                <#list getSingleCollectionOrders as order>
							    ...
							    <td class="botValue">${order.orderid}</td>
							      ...
							      <td class="botValue">
							       <a class="btn btcms" href="${ctx}/showCollectInfo.do?id=${order.id}"><i class="fa fa-train"></i>&nbsp;<@spring.message "view"/></a>
							      </td>
							    </tr>
							    </#list>
				              <#else>
					...
					<div class="tab-content">
						<form action="#" method="post" class="form-horizontal" id='addForm'>
							...
							<div class="form-actions">
								<button type="button" class="btn blue" id="saveNewConstant"><i class="icon-ok"></i> <@spring.message "save"/></button>
								<button type="button" class="btn blue" id='cancleConstantAdd'><@spring.message "cancle"/></button>
							</div>
						</form>
				</div>
	 		</div>
			...
			<div class="portlet-body form">
					<div class="tab-content">
						...
						<input type="hidden" value="" id="add_constant_tableName" />
							...
							<div class="form-actions">
								 <input type="button" class="btn blue" id="saveNewList" value=<@spring.message "confirm"/>   />
...
<div class="row-fluid"  id='showpssorderinfo'  style="display:none">
					<div class="tab-content">
						<form action="#" class="form-horizontal">
							...
							<div class="form-actions ">
								<button type="button" class="btn blue" id='showcancleAdd'><@spring.message "cancle"/></button>
							</div>
						</form>
				</div>
</div>
