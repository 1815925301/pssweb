$(function() {
    ...
    function n() {
        ...
        if ($(".J_menuTab").each(function() {
            ...
            var r = '<iframe class="J_iframe" name="iframe' + a + '" id="iframe' + a + '"  width="100%" height="100%" src="' + t + '?v=4.0" frameborder="0" data-id="' + t + '" seamless></iframe>';
		...
		$(this).parent().attr("class","start active");
		getMenuIfreamHeigth("iframe"+ a +"",true);
        return ! 1
    }
