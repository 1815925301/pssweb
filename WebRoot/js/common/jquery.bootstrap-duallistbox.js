;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: '收件人 {0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">过滤</span> {0} 从 {1}', // when not all of the options are visible due to the filter
