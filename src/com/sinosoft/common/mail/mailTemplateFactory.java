...
public class mailTemplateFactory {
	...
	private static Logger log = LoggerFactory.getLogger(mailTemplateFactory.class);

	// 模板文件路径
	private static String templatePath = "/mailtemplate";
	// 模板文件内容编码
	...
	static{
		//设置模板文件路径
		conf.setClassForTemplateLoading(mailTemplateFactory.class, templatePath);
