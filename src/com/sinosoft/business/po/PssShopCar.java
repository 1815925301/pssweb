...
public class PssShopCar {
	...
	//???       数据库字段: ORDERID 
	    ...
	    //????       数据库字段: SCENEDATE 
		private java.util.Date scenedate;
		
		
	    //??????       数据库字段: IMAGEINGSTARTTIME 
		private java.util.Date imageingstarttime;
		
		
	    //??????       数据库字段: IMAGEIMGSTOPTIME 
		private java.util.Date imageimgstoptime;
	    ...
	    //???? 1?  0?       数据库字段: DELSSTATUS 
		private Double delsstatus;
		...
		private String telmobile;	//联系电话
		
		private String email;		//电子邮箱
		
		private String department;	//客户住址
		...
		public String getImagedatebegin() {
			return imagedatebegin;
		}
		public void setImagedatebegin(String imagedatebegin) {
		...
		private String thematictype;	//专题产品类型
		
		private String imagedatebegin; 	//成像起始时间
		
		private String imagedateend; 	//成像结束时间
		
		private String spatialmax;	//分辨率最大值
		
		private String spatialmin;	//分辨率最小值
		...
		public java.util.Date getScenedate() {
			return scenedate;
		}


		public void setScenedate(java.util.Date scenedate) {
			this.scenedate = scenedate;
		}


		public java.util.Date getImageingstarttime() {
			return imageingstarttime;
		}


		public void setImageingstarttime(java.util.Date imageingstarttime) {
			this.imageingstarttime = imageingstarttime;
		}


		public java.util.Date getImageimgstoptime() {
			return imageimgstoptime;
		}


		public void setImageimgstoptime(java.util.Date imageimgstoptime) {
		...
		public Double getDataupperrightupperlong() {
			return dataupperrightupperlong;
		}
		...
		public void setAbccalibtype(java.lang.String abccalibtype) {
			this.abccalibtype = abccalibtype;
		}
		...
		public Double getDelsstatus() {
			return delsstatus;
		}


		public void setDelsstatus(Double delsstatus) {
			this.delsstatus = delsstatus;
		}
