...
public class ZipTools {  
    ...
    public static void zipFile(String baseDir,String fileName,String shpName) throws Exception{  
        ...
        for(int i = 0; i <fileList.size(); i++) {  
        	 ...
        	 String disasterName = f.getName().split("\\.")[0];
        	if(!shpName.equals(disasterName)){
        		continue;
        	}
    ...
    private static String getAbsFileName(String baseDir, File realFileName){  
        ...
        System.out.println("  root文件夹根目录:"+baseDir+"    子文件夹下的文件名称："+ret);
        while (true) {  
        ...
        System.out.println(real.getName()+" ****** "+ret);
        return ret;  
    }  
 ...
 public static void main(String[] args){
	 ...
	 try {
		//ZipTools.zipFile("D:/service","D:/service/service.zip");
	} catch (Exception e) {
		e.printStackTrace();
	}
